...
<b>Result 2: AST created with the first method</b>
Output:
![The AST generated by the above:](/LFAF_Labs/reports/lab_5_report/ast_graph.png)


<b>Result 3: AST created with the second method</b>
Output:
```
Module(
    body=[
...
<b>Result 4: Parsing a simple Python statement</b>
```
    Input:
    total = total + num
